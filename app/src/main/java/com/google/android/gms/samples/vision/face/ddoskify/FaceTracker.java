...
class FaceTracker extends Tracker<Face> {
     ...
     * recent face detection results.  The graphic will render the face.
     */
    @Override
    public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
        ...
        mFaceGraphic.updateEyes(leftPosition, rightPosition);
    }
    ...
    /**
     * Called when the face is assumed to be gone for good. Remove the face graphic from
     * the overlay.
     */
    @Override
    public void onDone() {
